	...
	<div class="main-navigation navbar-fixed-top">
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">MovieShop</a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					<li class="active"><a href="#banner">홈</a></li>
					<li><a href="#service">게시판</a></li>
					<li><a href="#portfolio">영화랭킹</a></li>
					<li><a href="#about">개봉예정영화</a></li>
					<li><a href="#contact">이메일문의</a></li>
				</ul>
			</div>
		</div>
		</nav>
		...
		<div class="container">
			<div class="row">
				<div class="jumbotron">
					<h1 class="small">
						영화를 쇼핑해보세요 
<!-- 						<span class="bold">Movie SHOP</span> -->
					</h1>
					<p class="big">&nbsp;&nbsp;&nbsp;영화 커뮤니티사이트 MovieShop에 오신걸 환영합니다.</p>
	...
	<div class="cta-1">
		<div class="container">
			<div class="row text-center white">
				...
				<p class="cta-sub-title">Full Responsive HTML5 Bootstrap
					Template.</p>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="port-sec">
					...
					<div id="Container">
						<div
							class="filimg mix category-1 category-3 col-md-4 col-sm-4 col-xs-12"
							data-myorder="2">
						...
						<div
							class="filimg mix category-2 category-3 col-md-4 col-sm-4 col-xs-12"
							data-myorder="8">
	...
	<div class="cta2">
		<div class="container">
			<div class="row white text-center">
				<h3 class="wd75 fnt-24">“Every Thing is designed. Few Things
					are Designed well.” - Brian Reed</h3>
				...
				<div class="form-sec">
					<form action="" method="post" role="form" class="contactForm">
						...
						<div class="col-md-12 form-group">
							...
							<button class="button-medium" id="contact-submit" type="submit"
								name="contact">Submit Now</button>
						</div>
					</form>
				</div>
			</div>
			...
			<div style="visibility: visible; animation-name: zoomIn;"
				...
				<div class="footer_copyright">
					...
					<div class="credits">
                        ...
                        -->
						Designed by <a href="https://bootstrapmade.com/">Bootstrap
							Themes</a>
					</div>
				</div>
			</div>
